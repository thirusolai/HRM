"""
This module provides Kangaroo ModelForms for creating and managing leave-related data,
...
from kangaroo_widgets.forms import KangarooForm, KangarooModelForm
...
class LeaveTypeAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f := self.fields.get("company_id"):
            from kangaroo_widgets.forms import default_select_option_template
...
class LeaveOneAssignForm(KangarooModelForm):
    """
    ...
    Attributes:
        - employee_id: A KangarooMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(KangarooForm):
    """
    Form for Payslip
    """
