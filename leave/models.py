...
class CompanyLeave(KangarooModel):
...
class AvailableLeave(KangarooModel):
...
class LeaveRequest(KangarooModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(KangarooModel):
    """
...
class LeaveAllocationRequest(KangarooModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(KangarooModel):
    """
...
class RestrictLeave(KangarooModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(KangarooModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(KangarooModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(KangarooModel):
        """
...
class EmployeePastLeaveRestrict(KangarooModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_kangaroo_model_class(
