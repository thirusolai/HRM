...
from kangaroo_views.cbv_methods import login_required
from kangaroo_views.generic.cbv.views import (
    KangarooCardView,
    KangarooDetailedView,
    KangarooFormView,
    KangarooListView,
    KangarooNavView,
    TemplateView,
...
class TimeSheetNavView(KangarooNavView):
    """
    Nav bar
    """
...
class TimeSheetList(KangarooListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = KangarooListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(KangarooFormView):
    """
...
class TimeSheetCardView(KangarooCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(KangarooDetailedView):
    """
