...
@method_decorator(login_required, name="dispatch")
class TaskListView(KangarooListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(KangarooNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(KangarooFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(KangarooDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(KangarooCardView):
    """
