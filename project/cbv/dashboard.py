...
from kangaroo_views.generic.cbv.views import KangarooDetailedView, KangarooListView
...
class ProjectsDueInMonth(KangarooListView):
...
class ProjectDetailView(KangarooDetailedView):
    """
