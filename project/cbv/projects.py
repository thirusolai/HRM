...
from kangaroo_views.cbv_methods import login_required, permission_required
from kangaroo_views.generic.cbv.views import (
    KangarooCardView,
    KangarooFormView,
    KangarooListView,
    KangarooNavView,
...
class ProjectsNavView(KangarooNavView):
    """
    Nav bar
    """
...
class ProjectsList(KangarooListView):
    """
    Projects list view
    """
...
class ProjectFormView(KangarooFormView):
    """
...
class ProjectCardView(KangarooCardView):
    """
    For card view
    """
...
# Remove the command lines after kangaroo converted into CBV
