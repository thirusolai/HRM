...
class ProjectStage(KangarooModel):
    """
    ProjectStage model
    """
    ...
    objects = KangarooCompanyManager("project__company_id")
...
class TimeSheet(KangarooModel):
    ...
    objects = KangarooCompanyManager("project_id__company_id")
