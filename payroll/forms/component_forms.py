...
from kangaroo_widgets.forms import KangarooForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = KangarooMultiSelectField(
...
class GeneratePayslipForm(KangarooForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(kangaroo_middlewares._thread_locals, "request", None)
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_kangaroo_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_kangaroo_model_class("leave", "availableleave")
