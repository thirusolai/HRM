...
from kangaroo.decorators import apply_decorators
...
class Bot:
    ...
    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=Kangaroo+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.kangaroo_history.all()
        ...
        return render(
            request,
            "kangaroo_audit/history_tracking.html",
            context,
        )
