...
from kangaroo_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "kangaroo_audit"


class KangarooAuditInfo(models.Model):
    """
    KangarooAuditInfo model to store additional info
    """
...
class KangarooAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(KangarooAuditLog, self).__init__(*args, **kwargs)
    #     self.is_kangaroo_audit_log = True
...
def pre_create_kangaroo_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_kangaroo_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, KangarooAuditLog):
