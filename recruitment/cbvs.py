...
class LinkedinSettingSectionView(views.KangarooSectionView):
    """
...
class LinkedInSettingNavView(views.KangarooNavView):
    """
...
class LinkedInAccountFormView(views.KangarooFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.KangarooListView):
    """
