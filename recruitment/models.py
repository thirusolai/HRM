...
from kangaroo_audit.methods import get_diff
from kangaroo_audit.models import KangarooAuditInfo, KangarooAuditLog
from kangaroo_views.cbv_methods import render_template
...
class SurveyTemplate(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager("company_id")
...
class Recruitment(KangarooModel):
    """
    Recruitment model
    """
...
class Stage(KangarooModel):
    ...
    objects = KangarooCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(KangarooModel):
    """
    RejectReason
    """
...
class RejectedCandidate(KangarooModel):
    """
    RejectedCandidate
    """
...
class StageFiles(KangarooModel):
...
class RecruitmentSurvey(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(KangarooModel):
    """
...
class RecruitmentSurveyAnswer(KangarooModel):
    """
...
class SkillZoneCandidate(KangarooModel):
    """
...
class CandidateRating(KangarooModel):
...
class RecruitmentGeneralSetting(KangarooModel):
    """
...
class InterviewSchedule(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(KangarooModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(KangarooModel):
...
class LinkedInAccount(KangarooModel):
