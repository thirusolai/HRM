...
This module is used to write kangaroo form select widgets
"""
...
class KangarooMultiSelectWidget(forms.Widget):
    """
    KangarooMultiSelectWidget
    """
    ...
    template_name = "kangaroo_widgets/kangaroo_multiselect_widget.html"
