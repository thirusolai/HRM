...
This module defines the abstract base model `KangarooModel` for the Kangaroo HRMS project.
The `KangarooModel` provides common fields and functionalities for other models within
...
class KangarooModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Kangaroo application.
    """
    ...
    kangaroo_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(KangarooModel, self).save(*args, **kwargs)
...
auditlog.register(KangarooModel, serialize_data=True)
