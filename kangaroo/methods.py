...
from kangaroo.kangaroo_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_kangaroo_model_class(app_label, model):
    """
...
def kangaroo_users_with_perms(permissions):
    """
