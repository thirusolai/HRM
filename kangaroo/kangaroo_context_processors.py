"""
kangaroo_context_process.py

This module is used to register context processors without effecting the kangaroo/settings.py module
"""

from kangaroo.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "kangaroo.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
