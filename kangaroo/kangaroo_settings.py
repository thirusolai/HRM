...
from kangaroo.kangaroo_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=kangaroo,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="kangaroo"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=kangaroo,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from kangaroo_ldap.models import LDAPSettings
