...
import kangaroo.kangaroo_settings


class KangarooLdapConfig(AppConfig):
    ...
    def ready(self):
        ...
        APPS.append("kangaroo_ldap")
        urlpatterns.append(
            path("", include("kangaroo_ldap.urls")),
        )
        super().ready()

        ldap_config = kangaroo.kangaroo_settings.load_ldap_settings()
