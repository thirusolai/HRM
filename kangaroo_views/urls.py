"""
kangaroo_views/urls.py
"""

from django.urls import path

from kangaroo_views import views
from kangaroo_views.generic.cbv import history
from kangaroo_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.KangarooDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "kangaroo-history-revert/<int:pk>/<int:history_id>/",
        history.KangarooHistoryView.as_view(),
        name="history-revert",
    ),
]
