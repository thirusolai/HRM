...
from kangaroo.signals import post_generic_delete, pre_generic_delete
from kangaroo_views import models
from kangaroo_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from kangaroo_views.forms import SavedFilterForm
from kangaroo_views.generic.cbv.views import KangarooFormView, KangarooListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.KangarooModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(KangarooFormView):
    """
    SavedFilter
    """
...
class DynamiListView(KangarooListView):
    """
...
class KangarooDeleteConfirmationView(View):
    """
