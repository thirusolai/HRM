...
class ToggleColumn(KangarooModel):
    """
    ToggleColumn
    """
...
class ActiveGroup(KangarooModel):
    """
    ActiveGroup
    """
...
class SavedFilter(KangarooModel):
    """
    SavedFilter
    """
...
class ActiveView(KangarooModel):
    """
