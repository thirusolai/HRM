"""
kangaroo_views/generic/cbv/history.py
"""
...
from kangaroo_views.cbv_methods import hx_request_required
from kangaroo_views.generic.cbv.views import KangarooFormView
from kangaroo_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class KangarooHistoryView(DetailView):
    """
    GenericKangarooProfileView
    """

    template_name = "generic/kangaroo_history_view.html"
