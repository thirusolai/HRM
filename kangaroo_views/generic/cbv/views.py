...
from kangaroo.filters import FilterSet
from kangaroo.group_by import group_by_queryset
from kangaroo.kangaroo_middlewares import _thread_locals
from kangaroo.signals import post_generic_import, pre_generic_import
from kangaroo_views import models
from kangaroo_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from kangaroo_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from kangaroo_views.templatetags.generic_template_filters import getattribute

logger = logging.getLogger(__name__)


@method_decorator(hx_request_required, name="dispatch")
class KangarooListView(ListView):
    """
    KangarooListView
    """
    ...
    template_name: str = "generic/kangaroo_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return KangarooFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[KangarooListView] = context
        from kangaroo.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class KangarooListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = KangarooListViewResorce()
...
class KangarooSectionView(TemplateView):
    """
    Kangaroo Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, KangarooListView)
    ...
    template_name = "generic/kangaroo_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class KangarooDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/kangaroo_detailed_view.html"
    header: dict = {
        "title": "Kangaroo",
        "subtitle": "Kangaroo Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, KangarooDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class KangarooTabView(TemplateView):
    """
    KangarooTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/kangaroo_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, KangarooTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[KangarooTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class KangarooCardView(ListView):
    """
    KangarooCardView
    """
    ...
    template_name = "generic/kangaroo_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, KangarooCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[KangarooCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class KangarooFormView(FormView):
    """
    KangarooFormView
    """
    ...
    template_name = "generic/kangaroo_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, KangarooFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "kangaroo_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[KangarooFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class KangarooNavView(TemplateView):
    """
    KangarooNavView
    ...
    template_name = "generic/kangaroo_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, KangarooNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[KangarooNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class KangarooProfileView(DetailView):
    """
    GenericKangarooProfileView
    """

    template_name = "generic/kangaroo_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, KangarooProfileView)
