...
from base.forms import ModelForm as KangarooModelForm
...
from kangaroo_widgets.widgets.select_widgets import KangarooMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = KangarooMultiSelectField(
            queryset=Employee.objects.all(),
            widget=KangarooMultiSelectWidget(
        ...
        self.fields["managers"] = KangarooMultiSelectField(
            queryset=Employee.objects.all(),
            widget=KangarooMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class KRForm(KangarooModelForm):
    """
...
class FeedbackForm(KangarooModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Kangaroo multi-select filter for subordinates
        # self.fields["subordinate_id"] = KangarooMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=KangarooMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class PeriodForm(KangarooModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("kangaroo_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], KangarooMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = KangarooMultiSelectField(
...
class BonusPointSettingForm(KangarooModelForm):
    """
...
class EmployeeBonusPointForm(KangarooModelForm):
    """
...
class EmployeeFeedbackForm(KangarooModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = KangarooMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=KangarooMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], KangarooMultiSelectField):
...
class BulkFeedbackForm(KangarooModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = KangarooMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=KangarooMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], KangarooMultiSelectField):
