...
class KeyResult(KangarooModel):
    ...
    history = KangarooAuditLog(bases=[KangarooAuditInfo])
...
class EmployeeObjective(KangarooModel):
    ...
    history = KangarooAuditLog(bases=[KangarooAuditInfo], related_name="history_set")
    archive = models.BooleanField(default=False)
...
class Comment(models.Model):
    ...
    history = KangarooAuditLog(excluded_fields=["comment"], bases=[KangarooAuditInfo])
    objects = KangarooCompanyManager(
...
class QuestionTemplate(KangarooModel):
...
class Question(KangarooModel):
    ...
    objects = KangarooCompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(KangarooModel):
    ...
    objects = KangarooCompanyManager("question_id__template_id__company_id")


class Feedback(KangarooModel):
...
class EmployeeBonusPoint(KangarooModel):
    employee_id = models.ForeignKey(
        Employee,
        on_delete=models.DO_NOTHING,
