...
from kangaroo.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.KangarooSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.KangarooNavView):
    """
...
class BonusPointSettingFormView(views.KangarooFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.KangarooListView):
    """
...
class EmployeeBonusPointSectionView(views.KangarooSectionView):
    """
...
class EmployeeBonusPointNavView(views.KangarooNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.KangarooFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.KangarooListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.KangarooFormView):
    """
...
class BulkFeedbackFormView(views.KangarooFormView):
    """
    Feedback other employee form View
    """
