...
class OnboardingStage(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(KangarooModel):
    """
...
class CandidateTask(KangarooModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(KangarooModel):
    """
