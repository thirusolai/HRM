...
from base.models import KangarooMailTemplate, JobPosition
...
from kangaroo.group_by import group_by_queryset as general_group_by
from kangaroo_documents.models import Document
...
def candidates_view(request):
    ...
    mail_templates = KangarooMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        KangarooMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
