...
from kangaroo_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- Field: also_sent_to ---
        self.fields["also_sent_to"] = KangarooMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], KangarooMultiSelectField):
