"""
kangaroo_automation/views/views.py
"""
...
from kangaroo_automations.methods.methods import generate_choices
from kangaroo_automations.methods.serialize import serialize_form
from kangaroo_automations.models import MailAutomation
from kangaroo_automations.signals import REFRESH_METHODS
from kangaroo_views.generic.cbv.views import KangarooFormView
...
@login_required
@permission_required("kangaroo_automations.delete_mailautomation")
...
@login_required
@permission_required("kangaroo_automations.add_mailautomation")
