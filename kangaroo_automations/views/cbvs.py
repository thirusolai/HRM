"""
kangaroo_automations/views/cbvs.py
"""
...
from base.models import KangarooMailTemplate
from kangaroo.decorators import login_required, permission_required
from kangaroo_automations import models
from kangaroo_automations.filters import AutomationFilter
from kangaroo_automations.forms import AutomationForm
from kangaroo_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("kangaroo_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.KangarooSectionView):
    """
    ...
    template_name = "kangaroo_automations/section_view.html"
...
class AutomationNavView(views.KangarooNavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("kangaroo_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("kangaroo_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.KangarooFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "kangaroo_automations/automation_form.html"
...
class AutomationListView(views.KangarooListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.KangarooDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("kangaroo_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "kangaroo_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = KangarooMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = KangarooMailTemplate.objects.filter(
                body=template_body
            ).first()
