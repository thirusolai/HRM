"""
kangaroo_automation/signals.py
...
from kangaroo.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from kangaroo_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=KangarooMailTemplate)
    @receiver(post_save, sender=KangarooMailTemplate)
...
def send_automated_mail(
    ...
    from kangaroo_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from kangaroo_automations.methods.methods import (
        get_model_class,
