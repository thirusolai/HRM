...
class AssetCategory(KangarooModel):
    """
...
class Asset(KangarooModel):
    ...
    objects = KangarooCompanyManager("asset_category_id__company_id")
...
class AssetReport(KangarooModel):
    """
...
class AssetDocuments(KangarooModel):
    """
...
class ReturnImages(KangarooModel):
    """
...
class AssetAssignment(KangarooModel):
    """
    ...
    objects = KangarooCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(KangarooModel):
    """
