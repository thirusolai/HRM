"""
kangaroo_api/urls/attendance/urls.py
"""

from django.urls import path

from kangaroo_api.api_views.attendance.permission_views import AttendancePermissionCheck
from kangaroo_api.api_views.attendance.views import *
