# Kangaroo API Documentation

This document provides information on how to use and maintain the API documentation for Kangaroo HRMS.
...
```python
from kangaroo_api.docs import document_api
...
- Module tags are defined in `kangaroo_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `kangaroo_api/urls.py`
