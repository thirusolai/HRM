...
class Offboarding(KangarooModel):
    """
    Offboarding model
    """
...
class OffboardingStage(KangarooModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(KangarooModel):
    """
...
class OffboardingEmployee(KangarooModel):
    """
...
class ResignationLetter(KangarooModel):
    """
...
class OffboardingTask(KangarooModel):
    """
...
class EmployeeTask(KangarooModel):
    """
    EmployeeTask model
    """
...
class ExitReason(KangarooModel):
    """
    ExitReason model
    """
...
class OffboardingNote(KangarooModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(KangarooModel):
    """
