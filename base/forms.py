...
class AssignPermission(Form):
    ...
    employee = KangarooMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = KangarooMultiSelectField(
...
class RotatingWorkTypeAssignForm(ModelForm):
    ...
    employee_id = KangarooMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = KangarooMultiSelectField(
        queryset=Employee.objects.all(),
        widget=KangarooMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], KangarooMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_kangaroo_model_class(app_label="leave", model="leavetype")
