...
class DefaultKangarooMailBackend(EmailBackend):
    def __init__(
        self,
        host=None,
        port=None,
...
BACKEND_CLASS: EmailBackend = DefaultKangarooMailBackend
default = "base.backends.ConfiguredEmailBackend"

setattr(BACKEND_CLASS, "send_messages", DefaultKangarooMailBackend.send_messages)
