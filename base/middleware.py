...
from kangaroo.kangaroo_apps import TWO_FACTORS_AUTHENTICATION
from kangaroo.kangaroo_settings import APPS
from kangaroo.methods import get_kangaroo_model_class
from kangaroo_documents.models import DocumentRequest

CACHE_KEY = "kangaroo_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_kangaroo_manager = isinstance(model.objects, KangarooCompanyManager)
        ...
        if is_company_model:
            ...
            elif is_kangaroo_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_kangaroo_model_class(app_label, model) for model in models]
                    )
