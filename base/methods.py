...
from kangaroo.kangaroo_apps import NESTED_SUBORDINATE_VISIBILITY
from kangaroo.kangaroo_middlewares import _thread_locals
from kangaroo.kangaroo_settings import KANGAROO_DATE_FORMATS, KANGAROO_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in KANGAROO_TIME_FORMATS.items():
