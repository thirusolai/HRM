...
class AttendanceActivity(KangarooModel):
    """
...
class BatchAttendance(KangarooModel):
    """
...
class Attendance(KangarooModel):
    """
    Attendance model
    """
...
class AttendanceRequestFile(KangarooModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(KangarooModel):
    """
...
class AttendanceOverTime(KangarooModel):
    """
...
class AttendanceLateComeEarlyOut(KangarooModel):
    """
...
class AttendanceValidationCondition(KangarooModel):
    """
...
class AttendanceGeneralSetting(KangarooModel):
    """
