...
from kangaroo.kangaroo_settings import DYNAMIC_URL_PATTERNS, KANGAROO_DATE_FORMATS
from kangaroo.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = KANGAROO_DATE_FORMATS.get(date_format)
