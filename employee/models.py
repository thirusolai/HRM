...
from kangaroo.models import KangarooModel, has_xss, upload_path
...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_kangaroo_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_kangaroo_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_kangaroo_model_class("recruitment", "recruitment")
            Stage = get_kangaroo_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_kangaroo_model_class("attendance", "attendance")
...
class EmployeeTag(KangarooModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(KangarooModel):
    """
...
class EmployeeNote(KangarooModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(KangarooModel):
    """
...
class BonusPoint(KangarooModel):
    """
...
class Actiontype(KangarooModel):
    """
    Action type model
    """
...
class DisciplinaryAction(KangarooModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(KangarooModel):
    """
...
class ProfileEditFeature(KangarooModel):
    """
    ProfileEditFeature
    """
